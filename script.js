...
if (newsletterForm) {
    newsletterForm.addEventListener('submit', (e) => {
        ...
        setTimeout(() => {
            alert('Thank you for subscribing! You won\'t miss any updates.');
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.education-card, .portfolio-item, .print-item, .about-content, .experience-content, .course-content');
